...
namespace GoodbyeBuddy
{
    ...
    public class PlayerController : MonoBehaviour, IPlayerController, IPhysicsObject
    {
        ...
        public void TickUpdate(float delta, float time) //recopila entrada jugador
        {
            ...
            GatherInput(); //Usa la entrada del jugador (PlayerInput) para actualizar la direcci�n, el estado de salto y el crecimiento Growing del jugador.
        }
        ...
        public void TickFixedUpdate(float delta) //Procesa logica movimiento y fisicas
        {
            ...
            SetFrameData(); //Configura rotaci�n, direcci�n y posici�n del jugador con marco actual, manteniendo consistencia en el estado.
